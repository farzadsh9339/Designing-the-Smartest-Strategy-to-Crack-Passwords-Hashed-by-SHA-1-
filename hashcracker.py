...
#                    test = self.hashtype(str(word))
#                    if test == self.user_hash:
#                       return str(word)
                    test = self.hashtype(str(word)+str(word1))
                    if test == self.user_hash:
                        return str(word)+str(word1)
##                    test = self.hashtype(str(word)+str(word1)+str(word2))
#                    if test == self.user_hash:
#                        return str(word)+str(word1)+str(word2)
